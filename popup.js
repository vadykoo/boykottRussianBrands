...
// Add event listener to the "addCustomBrandButton"
...
addCustomBrandButton.addEventListener("click", () => {
  const customBrand = customBrandInput.value;
  if (customBrand) {
    // Send a message to the background script to add the custom brand to the local storage
